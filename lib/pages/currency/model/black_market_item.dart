...
class BlackMarketItemComponent extends StatelessWidget {
//  final CurrencyBank item;
  final String image;
  final String name;
  final double currentBuyPrice;
  final double currentSellPrice;
  final String currentBuyPriceChange;
  final String currentSellPriceChange;
  final List<double> price;

  const BlackMarketItemComponent(
      {super.key,
        required this.name,
        ...
        child: Row(
          children: [
            Expanded(
              flex: 1,
              child: SizedBox(
                  height: myHeight * 0.03, child: Image.network(image)),
            ),
            Expanded(
              flex: 1,
              child: Column(
            ...
            Expanded(
              ...
              child: SizedBox(
                ...
                child: Sparkline(
                  ...
                  lineWidth: 2.0,
                  lineColor:
                  currentBuyPriceChange == 'red' ? Colors.red : Colors.green,
                  fillMode: FillMode.below,
                  fillGradient: LinearGradient(
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                      stops: const [0.0, 0.7],
                      colors: currentBuyPriceChange != 'red'
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                            ...
                            style: TextStyle(
                              color: currentBuyPriceChange != 'red'
                                  ? Colors.green
                                  : Colors.red,
                            ),
