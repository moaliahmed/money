...
class ChartState extends StatefulWidget {
  const ChartState({super.key});

  @override
  State<ChartState> createState() => _ChartStateState();
}

class _ChartStateState extends State<ChartState> {
  late List<ChartSampleData> _chartDate;
  late TrackballBehavior _trackballBehavior;

  @override
  void initState() {
    super.initState();
    _chartDate = getChartDate();
  ...
  List<ChartSampleData> getChartDate() {
